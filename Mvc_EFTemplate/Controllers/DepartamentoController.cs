...
namespace Mvc_EFTemplate.Controllers
{
    public class DepartamentoController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include="Id,Nome")] Departamento departamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include="Id,Nome")] Departamento departamento)
        {
            if (ModelState.IsValid)
            {
